...
if(isset($_POST['submit'])){
   ...
   $add_playlist = $conn->prepare("INSERT INTO `playlist`(id, tutor_id, title,level,description, thumb, status) VALUES(?,?,?,?,?,?,?)");
   $add_playlist->execute([$id, $tutor_id, $title,$level, $description, $rename, $status]);
