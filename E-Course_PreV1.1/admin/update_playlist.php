...
if(isset($_POST['submit'])){
   ...
   $update_playlist = $conn->prepare("UPDATE `playlist` SET title = ?, level = ?,description = ?, status = ? WHERE id = ?");
   $update_playlist->execute([$title,$level, $description, $status, $get_id]);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         ...
         <option value="deactive">deactive</option>
            ...
            <p>playlist Level <span>*</span></p>
      <select name="level" class="box" required>
         <option value="<?= $fetch_playlist['level']; ?>" selected><?= $fetch_playlist['level']; ?></option>
