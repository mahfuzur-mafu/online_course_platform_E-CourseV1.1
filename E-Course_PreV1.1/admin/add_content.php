...
if(isset($_POST['submit'])){
   ...
   if($thumb_size > 2000000){
      ...
      $add_playlist = $conn->prepare("INSERT INTO `content`(id, tutor_id, playlist_id, level,title, description, video, thumb, status) VALUES(?,?,?,?,?,?,?,?,?)");
      $add_playlist->execute([$id, $tutor_id, $playlist, $level, $title, $description, $rename_video, $rename_thumb, $status]);
