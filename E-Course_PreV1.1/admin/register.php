...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_tutor = $conn->prepare("INSERT INTO `tutors`(id, name,gender, profession, email, password, image) VALUES(?,?,?,?,?,?,?)");
         $insert_tutor->execute([$id, $name, $gender,$profession, $email, $cpass, $rename]);
