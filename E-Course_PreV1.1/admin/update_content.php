...
if(isset($_POST['update'])){
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, level = ? ,description = ?, status = ? WHERE id = ?");
   $update_content->execute([$title ,$level,$description, $status, $video_id]);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         ...
         <option value="deactive">deactive</option>
            ...
            <p>update level <span>*</span></p>
      <select name="level" class="box" required>
         <option value="<?= $fecth_videos['level']; ?>" selected><?= $fecth_videos['level']; ?></option>
